...
export const socialDesignTokens = {
  ...
  components: {
    ...
    background: {
      ...
      // Pattern flow values used by renderSocialBackground.ts.
      // Pixel values are scaled by createSocialDesignSystem; structural
      // values such as columns, rotation and stagger stay constant.
      patternInsetX: 72,
      patternInsetY: 72,
      patternGap: 28,
      patternRowGap: 24,
    ...
    badge: {
      // Social badge = CTA-like label, not pill/chip.
      // Shape matches the promo buttons style: compact rounded rectangle,
      // strong typography, solid/outline variants and no marker by default.
      height: 60,
      radius: 14,
      paddingX: 28,
      paddingY: 14,
